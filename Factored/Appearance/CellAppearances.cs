...
namespace Factored.MapObjects
{
	public static class CellAppearances
	{
		...
		public static readonly CellAppearance FloorFov = new CellAppearance( Colors.Floor, Colors.FloorBackground, 46 );
		public static readonly CellAppearance WallFov = new CellAppearance( Colors.Wall, Colors.WallBackground, 35 );
		public static readonly CellAppearance CorridorFov = new CellAppearance( Colors.Corridor, Colors.CorridorBG, 44 );
