...
using Factored.MapObjects.Features;
...
namespace Factored.MapBuilder
{
	...
	public class csMapbuilder
	{
		...
		//room properties
		[Category( "Room" ), Description( "Minimum Point" ), DisplayName( "Minimum Point" )]
		public Point Room_Min { get; set; }
		[Category( "Room" ), Description( "Max Point" ), DisplayName( "Maximum Point" )]
		...
		[Category( "Map" ), DisplayName( "Map Point" )]
		...
		private int doorcell = ( int ) TileType.Door;
		private int corridorcell = ( int ) TileType.Corridor;
		private int wallcell = ( int ) TileType.Wall;
		private int floorcell = ( int ) TileType.Floor;
		private int empty = (int) TileType.None;
		...
		public csMapbuilder( int x, int y )
		{
			...
			Corridor_Max = 15;
			MaxRooms = 15;
			Map_Size = new Point( Map_Size.X, Map_Size.Y );
